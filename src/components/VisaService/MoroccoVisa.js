    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-8">
          <h1 className="text-3xl font-bold text-red-600 mb-2">Morocco Visa Service</h1>
          <p className="text-gray-600">
            Get your Morocco visa processed with ease and reliability.
          </p>
        </header>
